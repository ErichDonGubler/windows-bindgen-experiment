...
extern "system" {
    ...
    pub fn D3DCompile(
        ...
        srcdatasize: usize,
        psourcename: ::windows_sys::core::PCSTR,
        pdefines: *const super::D3D_SHADER_MACRO,
        pinclude: super::ID3DInclude,
        pentrypoint: ::windows_sys::core::PCSTR,
        ptarget: ::windows_sys::core::PCSTR,
        flags1: u32,
        flags2: u32,
    ...
    pub fn D3DCompileFromFile(
        pfilename: ::windows_sys::core::PCWSTR,
        pdefines: *const super::D3D_SHADER_MACRO,
        pinclude: super::ID3DInclude,
        pentrypoint: ::windows_sys::core::PCSTR,
        ptarget: ::windows_sys::core::PCSTR,
    ...
    pub fn D3DCompressShaders(
        ...
        uflags: u32,
        ppcompresseddata: *mut super::ID3DBlob,
    ) -> ::windows_sys::core::HRESULT;
    #[doc = "*Required features: `\"Win32_Graphics_Direct3D_Fxc\"`*"]
    pub fn D3DCreateBlob(size: usize, ppblob: *mut super::ID3DBlob)
        -> ::windows_sys::core::HRESULT;
    ...
    pub fn D3DCreateFunctionLinkingGraph(
        uflags: u32,
        ppfunctionlinkinggraph: *mut super::super::Direct3D11::ID3D11FunctionLinkingGraph,
    ) -> ::windows_sys::core::HRESULT;
    #[doc = "*Required features: `\"Win32_Graphics_Direct3D_Fxc\"`, `\"Win32_Graphics_Direct3D11\"`*"]
    #[cfg(feature = "Win32_Graphics_Direct3D11")]
    pub fn D3DCreateLinker(
        pplinker: *mut super::super::Direct3D11::ID3D11Linker,
    ) -> ::windows_sys::core::HRESULT;
    #[doc = "*Required features: `\"Win32_Graphics_Direct3D_Fxc\"`*"]
    ...
    pub fn D3DDisassemble(
        ...
        srcdatasize: usize,
        flags: u32,
        szcomments: ::windows_sys::core::PCSTR,
        ppdisassembly: *mut super::ID3DBlob,
    ) -> ::windows_sys::core::HRESULT;
    ...
    pub fn D3DDisassemble10Effect(
        peffect: super::super::Direct3D10::ID3D10Effect,
        flags: u32,
        ppdisassembly: *mut super::ID3DBlob,
    ) -> ::windows_sys::core::HRESULT;
    #[doc = "*Required features: `\"Win32_Graphics_Direct3D_Fxc\"`*"]
    ...
    pub fn D3DGetBlobPart(
        ...
        part: D3D_BLOB_PART,
        flags: u32,
        pppart: *mut super::ID3DBlob,
    ) -> ::windows_sys::core::HRESULT;
    #[doc = "*Required features: `\"Win32_Graphics_Direct3D_Fxc\"`*"]
    pub fn D3DGetDebugInfo(
        psrcdata: *const ::core::ffi::c_void,
        srcdatasize: usize,
        ppdebuginfo: *mut super::ID3DBlob,
    ) -> ::windows_sys::core::HRESULT;
    #[doc = "*Required features: `\"Win32_Graphics_Direct3D_Fxc\"`*"]
    pub fn D3DGetInputAndOutputSignatureBlob(
        psrcdata: *const ::core::ffi::c_void,
        srcdatasize: usize,
        ppsignatureblob: *mut super::ID3DBlob,
    ) -> ::windows_sys::core::HRESULT;
    #[doc = "*Required features: `\"Win32_Graphics_Direct3D_Fxc\"`*"]
    ...
    pub fn D3DLoadModule(
        psrcdata: *const ::core::ffi::c_void,
        cbsrcdatasize: usize,
        ppmodule: *mut super::super::Direct3D11::ID3D11Module,
    ) -> ::windows_sys::core::HRESULT;
    #[doc = "*Required features: `\"Win32_Graphics_Direct3D_Fxc\"`*"]
    pub fn D3DPreprocess(
        ...
        pdefines: *const super::D3D_SHADER_MACRO,
        pinclude: super::ID3DInclude,
        ppcodetext: *mut super::ID3DBlob,
        pperrormsgs: *mut super::ID3DBlob,
    ) -> ::windows_sys::core::HRESULT;
    #[doc = "*Required features: `\"Win32_Graphics_Direct3D_Fxc\"`*"]
    pub fn D3DReadFileToBlob(
        pfilename: ::windows_sys::core::PCWSTR,
        ppcontents: *mut super::ID3DBlob,
    ) -> ::windows_sys::core::HRESULT;
    #[doc = "*Required features: `\"Win32_Graphics_Direct3D_Fxc\"`*"]
    pub fn D3DReflect(
        psrcdata: *const ::core::ffi::c_void,
        srcdatasize: usize,
        pinterface: *const ::windows_sys::core::GUID,
    ...
    pub fn D3DSetBlobPart(
        ...
        partsize: usize,
        ppnewshader: *mut super::ID3DBlob,
    ) -> ::windows_sys::core::HRESULT;
    #[doc = "*Required features: `\"Win32_Graphics_Direct3D_Fxc\"`*"]
    pub fn D3DStripShader(
        ...
        ustripflags: u32,
        ppstrippedblob: *mut super::ID3DBlob,
    ) -> ::windows_sys::core::HRESULT;
    #[doc = "*Required features: `\"Win32_Graphics_Direct3D_Fxc\"`, `\"Win32_Foundation\"`*"]
    #[cfg(feature = "Win32_Foundation")]
    pub fn D3DWriteBlobToFile(
        pblob: super::ID3DBlob,
        pfilename: ::windows_sys::core::PCWSTR,
        boverwrite: super::super::super::Foundation::BOOL,
    ) -> ::windows_sys::core::HRESULT;
}
#[doc = "*Required features: `\"Win32_Graphics_Direct3D_Fxc\"`*"]
pub const D3DCOMPILER_DLL_A: ::windows_sys::core::PCSTR = ::windows_sys::s!("d3dcompiler_47.dll");
#[doc = "*Required features: `\"Win32_Graphics_Direct3D_Fxc\"`*"]
pub const D3DCOMPILER_DLL_W: ::windows_sys::core::PCWSTR = ::windows_sys::w!("d3dcompiler_47.dll");
#[doc = "*Required features: `\"Win32_Graphics_Direct3D_Fxc\"`*"]
...
#[doc = "*Required features: `\"Win32_Graphics_Direct3D_Fxc\"`*"]
pub type pD3DCompile = ::core::option::Option<
...
>;
#[doc = "*Required features: `\"Win32_Graphics_Direct3D_Fxc\"`*"]
pub type pD3DDisassemble = ::core::option::Option<
    unsafe extern "system" fn(
        psrcdata: *const ::core::ffi::c_void,
        srcdatasize: usize,
        flags: u32,
...
>;
#[doc = "*Required features: `\"Win32_Graphics_Direct3D_Fxc\"`*"]
pub type pD3DPreprocess = ::core::option::Option<
    unsafe extern "system" fn(
        psrcdata: *const ::core::ffi::c_void,
        srcdatasize: usize,
        pfilename: ::windows_sys::core::PCSTR,
