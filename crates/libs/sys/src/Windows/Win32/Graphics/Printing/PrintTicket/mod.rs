...
extern "system" {
    ...
    pub fn PTConvertDevModeToPrintTicket(
        ...
        pprintticket: super::super::super::System::Com::IStream,
    ) -> ::windows_sys::core::HRESULT;
    #[doc = "*Required features: `\"Win32_Graphics_Printing_PrintTicket\"`, `\"Win32_Foundation\"`, `\"Win32_Graphics_Gdi\"`, `\"Win32_Storage_Xps\"`, `\"Win32_System_Com\"`*"]
    #[cfg(all(
        feature = "Win32_Foundation",
    ...
    pub fn PTConvertPrintTicketToDevMode(
        ...
        pbstrerrormessage: *mut ::windows_sys::core::BSTR,
    ) -> ::windows_sys::core::HRESULT;
    ...
    pub fn PTGetPrintCapabilities(
        hprovider: super::super::super::Storage::Xps::HPTPROVIDER,
        pprintticket: super::super::super::System::Com::IStream,
        pcapabilities: super::super::super::System::Com::IStream,
        pbstrerrormessage: *mut ::windows_sys::core::BSTR,
    ) -> ::windows_sys::core::HRESULT;
    #[doc = "*Required features: `\"Win32_Graphics_Printing_PrintTicket\"`, `\"Win32_Storage_Xps\"`, `\"Win32_System_Com\"`*"]
    #[cfg(all(feature = "Win32_Storage_Xps", feature = "Win32_System_Com"))]
    pub fn PTGetPrintDeviceCapabilities(
        hprovider: super::super::super::Storage::Xps::HPTPROVIDER,
        pprintticket: super::super::super::System::Com::IStream,
        pdevicecapabilities: super::super::super::System::Com::IStream,
        pbstrerrormessage: *mut ::windows_sys::core::BSTR,
    ) -> ::windows_sys::core::HRESULT;
    #[doc = "*Required features: `\"Win32_Graphics_Printing_PrintTicket\"`, `\"Win32_Storage_Xps\"`, `\"Win32_System_Com\"`*"]
    #[cfg(all(feature = "Win32_Storage_Xps", feature = "Win32_System_Com"))]
    pub fn PTGetPrintDeviceResources(
        hprovider: super::super::super::Storage::Xps::HPTPROVIDER,
        pszlocalename: ::windows_sys::core::PCWSTR,
        pprintticket: super::super::super::System::Com::IStream,
        pdeviceresources: super::super::super::System::Com::IStream,
        pbstrerrormessage: *mut ::windows_sys::core::BSTR,
    ) -> ::windows_sys::core::HRESULT;
    #[doc = "*Required features: `\"Win32_Graphics_Printing_PrintTicket\"`, `\"Win32_Storage_Xps\"`, `\"Win32_System_Com\"`*"]
    #[cfg(all(feature = "Win32_Storage_Xps", feature = "Win32_System_Com"))]
    pub fn PTMergeAndValidatePrintTicket(
        hprovider: super::super::super::Storage::Xps::HPTPROVIDER,
        pbaseticket: super::super::super::System::Com::IStream,
        pdeltaticket: super::super::super::System::Com::IStream,
        scope: EPrintTicketScope,
        presultticket: super::super::super::System::Com::IStream,
        pbstrerrormessage: *mut ::windows_sys::core::BSTR,
    ) -> ::windows_sys::core::HRESULT;
    #[doc = "*Required features: `\"Win32_Graphics_Printing_PrintTicket\"`, `\"Win32_Storage_Xps\"`*"]
    #[cfg(feature = "Win32_Storage_Xps")]
    pub fn PTOpenProvider(
        ...
        dwversion: u32,
        phprovider: *mut super::super::super::Storage::Xps::HPTPROVIDER,
    ) -> ::windows_sys::core::HRESULT;
    #[doc = "*Required features: `\"Win32_Graphics_Printing_PrintTicket\"`, `\"Win32_Storage_Xps\"`*"]
    #[cfg(feature = "Win32_Storage_Xps")]
